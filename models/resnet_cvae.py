...
class ResNet_cVAE(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        background, no_mask, targets, mask = batch
...
if __name__ == "__main__":
    config = read_yaml('./../configs/consep/config_resnet_cvae.yaml')
    ...
    model = ResNet_cVAE(config, train_ds, valid_ds, test_ds)
