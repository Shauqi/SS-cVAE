...
def get_datasets(config):
    train_dir = config['CONTRASTIVE_MODEL_TRAIN']['in_distribution']['train_dir']
    val_dir = config['CONTRASTIVE_MODEL_TRAIN']['in_distribution']['val_dir']
    test_dir = config['CONTRASTIVE_MODEL_TRAIN']['in_distribution']['test_dir']
...
if __name__ == '__main__':
    ...
    model = ContrastivePhiSeg(config, train_dataset, val_dataset)
