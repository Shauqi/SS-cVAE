...
def get_model(config):
    ...
    elif model_name == 'contrastive_ss_cvae_one_stage_ablation':
        from models.ss_cvae_one_stage_ablation import SS_cVAE
        model = SS_cVAE.load_from_checkpoint(chkpt_dir, config = config['CONTRASTIVE_MODEL_TRAIN'])
    elif model_name == 'contrastive_ss_cvae_ablation':
...
if __name__ == '__main__':
    ...
    for img, label, mask in tqdm(test_loader):
        ...
        if model_name == 'contrastive_mm_cvae' or model_name == 'resnet_cvae' or model_name == 'contrastive_cvae' or model_name == 'contrastive_ss_cvae_one_stage_ablation' or model_name == 'contrastive_ss_cvae_ablation':
