...
def filter_patches(config, mode = 'Train'):
    INPUT_DIR = f"{config['PROJECT_DIR']}{config['BINARY_PATCH_FILTER']['INPUT_DIR']}"
    OUTPUT_DIR = f"{config['PROJECT_DIR']}{config['BINARY_PATCH_FILTER']['OUTPUT_DIR']}"
    VISUALIZATION_DIR = f"{config['PROJECT_DIR']}{config['BINARY_PATCH_FILTER']['VISUALIZATION_DIR']}"
    ...
    for img_file in tqdm(img_files):
        ...
        for patch_file in patch_files:
            ...
            cell_area = sum(type_percentage.values())
            cell_ratio = cell_area / patch_area
            ...
            # total_instances = sum(type_percentage.values())
...
def combine_filtered_patches(config, mode = 'Train'):
    INPUT_DIR = f"{config['PROJECT_DIR']}{config['BINARY_PATCH_FILTER']['OUTPUT_DIR']}"
    OUTPUT_DIR = f"{config['PROJECT_DIR']}{config['BINARY_PATCH_FILTER']['OUTPUT_DIR']}"
