...
def filter_patches(config, mode = 'Train'):
    INPUT_DIR = config['PATCH_FILTER']['INPUT_DIR']
    OUTPUT_DIR = config['PATCH_FILTER']['OUTPUT_DIR']
    VISUALIZATION_DIR = config['PATCH_FILTER']['VISUALIZATION_DIR']
    ...
    for img_file in tqdm(img_files):
        ...
        for patch_file in patch_files:
            ...
            if type_percentage['BACKGROUND'] >= 0.90:
...
def combine_filtered_patches(config, mode = 'Train'):
    INPUT_DIR = config['PATCH_FILTER']['OUTPUT_DIR']
    OUTPUT_DIR = config['PATCH_FILTER']['OUTPUT_DIR']
