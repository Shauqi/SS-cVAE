...
def main(args):
    ...
    print(model_dir)
    print(dataset)
    print(args.max_traversal)
    print(args.upsample_factor)
    viz = Visualizer(model=model, model_dir=model_dir, dataset=dataset, max_traversal=args.max_traversal, loss_of_interest='kl_loss_', upsample_factor=args.upsample_factor)
