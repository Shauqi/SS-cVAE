...
class BetaVAE_H(nn.Module):
    ...
    def forward(self, x, c, encode_only, decode_only, test):
        if encode_only:
    ...
    def __call__(self, x=None, c=None, encode_only=False, decode_only=False, test=False):
        return self.forward(x, c, encode_only, decode_only, test)
